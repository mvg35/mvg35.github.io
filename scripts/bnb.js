        ...
        section_name: ['Iniciales/Generales'], tasks: [
            {
                ...
                text: [
                    'En este gabinete al fondo encontrara esta llave, la cual abre el cuartito de atras donde esta todo lo necesario para la limpieza'
        ...
        section_name: ['Sala'], tasks: [
            {
                ...
                text: [
                    'Mover sofa, y verificar que esta extension este conectada y que tenga ese aparatito conectado'
                ], content: 'candado.jpg'
            },
        ]
    }, {
