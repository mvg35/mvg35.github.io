const cleaningConfig = [
  {
    ...
    tasks: [
      ...
      {
        text: [
          "Entre al fraccionamiento, de  un giro a la izquierda, seguido por uno a la derecha, y siga hasta el fondo. Es la casa blanca que se ve hasta el final. Dirección es Real de Grijalva 8987",
        ],
        content: "view.jpeg",
      },
      {
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        text: [
          "En este cajon al fondo encontraran una llave verde. Esta abre el cuartito de atras. Favor de regresarla a su lugar cuando ya no se este usando."
        ],
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        text: [
          "Verificar que esta extension este conectada y que tenga ese aparatito conectado, FAVOR DE APAGAR Y PRENDER LA EXTENSION YA QUE ES NECESARIA PARA QUE SIRVA LA PUERTA PRINCIPAL.",
        ],
        content: "candado.jpg",
      },
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        text: [
          "Verificar que el refrigerador y congelador esten limpios, tirar todo lo que este abierto o caducando. Se pueden dejar aguas y sodas cerradas. Favor de tirar o llevarse lo demas si le interesa",
        ],
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        text: [
          `Dejar un rollo de papel nuevo puesto en cada baño. Dejar nada mas 1 rollo extra por cada 2 dias extras que se quedan o estadia es de tres dias o mas.
...
const bnbConfig = [
  {
    ...
    tasks: [
      ...
      {
        text: [
          "Recibirán un código QR que abre la reja del fraccionamiento solo la primeras 3 entradas el dia de su llegada. Solo funciona en carro, si llegara a pie favor de informarme",
          "We will send you a QR code that will open the community's gate for 3 times your first day only. Only works for car entrance, if you are arriving by foot, please let me know",
        ],
      },
      {
        text: [
          "Entre al fraccionamiento, de un giro a la izquierda, seguido por uno a la derecha, y siga hasta el fondo. Es la casa blanca que se ve hasta el fondo. Real de Grijalva 8987",
          "After entering the gate, turn left instantly, followed by a right turn, then keep going straight down the street. It's the white house that's down the road. Real de Grijalva 8987",
        ],
        content: "view.jpeg",
      },
      {
        text: [
          "Recibiran un código de acceso para la puerta principal de la casa antes de su entrada (1:50pm). Este código les servira durante toda su estadía hasta su hora de salida (9:00am). Favor de tratar de manternar las otras puertas cerradas y con seguro.",
          "You will be receiveng an access code before your check-in (1:50pm) which should open the house's front door. You will be using this code throughout your stay until your check-out (9:00am). Please try to maintain the other doors closed and locked.",
        ],
        content: ["keypad_esp.png", "keypad.png"],
      },
      {
        text: [
          "Al entrar vera una tarjeta blanca, esta le servira para abrir la reja del fraccionamiento en carro en vez del código QR por el resto de su estadia. FAVOR DE CUIDARLA YA QUE SE LES TENDRA QUE COBRAR EN CASO DE SER EXTRAVIADA",
          "You should see a small white card right after entering, which will serve you to open the community's car gate for the rest of your stay. PLEASE TAKE CARE OF IT SINCE WE WILL HAVE TO CHARGE YOU IN CASE IT GETS LOST",
        ],
      },
      {
        text: [
          "El fraccionamiento cuenta con una puerta peatonal, la cual usa un codigo de 6 digitos para entrar que cambian cada día. Si lo requiere, favor de pedirmelo. Tambien se usa en caso de Uber o UberEats. La seguridad del fraccionamiento es estricta en este tema.",
          "The community's gate also counts with a pedestrian door, which uses a 6 digits code that changes every day. If you require it, please ask me for it. This code is also used for Uber or UberEats. The community's guard is very strict on this topic.",
        ],
      },
      {
        text: [
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        text: [
          "Favor de no desconectar esta extension ni el aparato que esta pegado, ya que es necesario para que funcione la puerta principal.",
          "Please do not unplug this extension or the device attached to it, since it is necessary for the front door to work.",
        ],
        content: "candado.jpg",
      },
    ],
    ...
    tasks: [
      {
        text: [
          ...
          "Please dispose of toilet paper inside the toilet, not the trash can. Moderately.",
        ],
      },
      {
        text: [
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        text: [
          "Favor de mandarme un mensaje de que ya han salido de la casa.",
          "Please let me know when you've left the property.",
        ],
      },
      {
        text: [
...
class Tabs extends React.Component {
  ...
  render() {
    ...
    const greetings = this.isCleaning()
      ...
      : [
          ...
          "Hello and welcome to your home for the following days",
        ];
    ...
    const general = ["", ""];
    const continua = ["Continuar", "Continue"];
    const inicio = ["Inicio", "Start"];
        ...
        <div className="container" style={{ textAlign: "center" }}>
          ...
          >
            <div className="modal-content">
              <h5>{greetings[this.state.lang]}</h5>
              <div className="row">
        ...
        <div style={{ height: "100%" }}>
          <ul id="slide-out" className="sidenav">
              ...
              return (
                <li key={index} className="tablinks">
                  <a
                    ...
                    id={"section-" + index}
                    onClick={(event) =>
                      this.tabClick(event, con.section_name[this.state.lang])
                    }
                  >
            ...
            <li style={{ marginTop: "2em" }}>
              <a
                className="waves-effect"
                onClick={() => this.state.modals[0].open()}
                style={{ color: "gray" }}
              >
          ...
          <div className="tab-content-div">
            {config.map((con, index) => {
              return (
                <div
                  id={con.section_name[this.state.lang]}
                  ...
                  {con.tasks.map((task, index) => {
                    return (
                      <div key={index}>
                        ...
                        <div>
                          {task.content ? this.renderContent(task) : ""}
                        </div>
                      </div>
                    );
                  })}
  ...
  renderContent(task) {
    const image = Array.isArray(task.content) ? task.content[this.state.lang] : task.content;
    return (
      <div className="row">
...
ReactDOM.render(<Tabs />, document.getElementById("react-div"));
